...
%prep
%setup -q -n system-config-printer-1.5.16
cd %{_builddir}/system-config-printer-1.5.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645732716
...
cp %{_builddir}/system-config-printer-1.5.16/COPYING %{buildroot}/usr/share/package-licenses/system-config-printer/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
